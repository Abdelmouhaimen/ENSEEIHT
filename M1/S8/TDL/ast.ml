...
type affectable = Ident of string | Deref of affectable | Acces of affectable * expression
...
and expression =
  ...
  |Newtableau of typ * expression

  |Initialisation of expression list
...
module AstTds =
struct
  type affectable = Ident of Tds.info_ast | Deref of affectable | Acces of affectable * expression
  ...
  and instruction =
    ...
    | For of typ * Tds.info_ast * expression * expression * Tds.info_ast * expression * bloc
    | Goto of Tds.info_ast 
    | Etiquette of Tds.info_ast 
...
and expression = AstType.expression
